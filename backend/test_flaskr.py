...
class BookTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.database_path = "postgres://{}:{}@{}/{}".format('fuzzytake','postgres','localhost:5432',self.database_name)
    ...
    def test_get_paginated_books_self(self):
        res = self.client().get('/books') # for API testing, make a call using the client to the given endpoint
        data = json.loads(res.data)

        self.assertEqual(res.status_code, 200) # assertion for a successful request.
    ...
    #     data = json.loads(res.data)
    #
    #     book = Book.query.filter_by(Book.id == 1).one_or_none()
    #
    #     self.assertEqual(res.status_code, 200)
    #     self.assertEqual(data['success'], True)
